...
export const ARCADE_GAME_RULES: Record<string, GameRuleDetail> = {
  ...
  pool: {
    ...
    howToPlay: [
      ...
      "DIAMOND & CAROM MASTER SUITE: 1-Rail midpoint, Plus-Two (Aim = Arrival - Origin), Corner-5, Renverse, Grand Traverse, Umbrella, Butterfly, K-System, Dead-Ball stun, Five-Ball (Aim = Origin x Arrival / 5), Rojano, and Sarda systems!"
    ],
    ...
    proTip: "Master the Five-Ball System (Aim = Origin x Arrival / 5) with a pure sliding stun hit (-0.5 tips low) for perfectly predictable 90° tangent caroms!"
  },
  "2048": {
    id: "2048",
    name: "2048 Binary Merge",
