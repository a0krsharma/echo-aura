...
const GAME_META: Record<string, { name: string; icon: string; desc: string; maxAllowed: number }> = {
  ...
  yahtzee: { name: "YAHTZEE MATRIX DICE", icon: "🎲", desc: "5-dice combo strategy with 13 scorecard slots", maxAllowed: 4 },
  liars_dice: { name: "LIAR'S DICE / PERUDO", icon: "🎲", desc: "Secret dice roll bluffing with global quantity calls", maxAllowed: 6 },
