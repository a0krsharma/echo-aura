...
const GAME_META: Record<string, { name: string; icon: string; desc: string; maxAllowed: number }> = {
  ...
  pool: { name: "8-BALL POOL", icon: "🎱", desc: "2D real-time physics pool table", maxAllowed: 2 },
  carrom: { name: "CARROM BOARD", icon: "⚪", desc: "Striker & coin pocketing physics", maxAllowed: 2 },
  ...
  mastermind: { name: "MASTERMIND CIPHER", icon: "🔐", desc: "Deduce hidden 4-digit code", maxAllowed: 1 },
  ...
  liars_dice: { name: "LIAR'S DICE", icon: "🎲", desc: "Hidden tray bluffing & challenge protocol", maxAllowed: 6 },
  codenames: { name: "CODENAMES", icon: "🕵️", desc: "5x5 word decryption grid with spymaster", maxAllowed: 8 },
  spyfall: { name: "SPYFALL / IMPOSTOR", icon: "🎭", desc: "Audio interrogation & cipher imposter deduction", maxAllowed: 8 },
  skribbl: { name: "VECTOR SKRIBBL", icon: "🎨", desc: "Live vector sketching & word guessing", maxAllowed: 8 },
  trivia: { name: "SIGNAL RACE QUIZ", icon: "⚡", desc: "Multiple choice code & tech speed race", maxAllowed: 8 },
  quoridor: { name: "QUORIDOR RUNNER", icon: "🧱", desc: "Pawn race with blocking firewall walls", maxAllowed: 2 },
  go: { name: "GO / WEIQI 19X19", icon: "⚪", desc: "Ancient territory surrounding matrix", maxAllowed: 2 },
  yahtzee: { name: "YAHTZEE DICE", icon: "🎲", desc: "Roll 5 dice & complete scoring categories", maxAllowed: 4 },
