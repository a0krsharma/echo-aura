...
import { Radio, Compass, Mic2, Swords, Search, MessageSquare, Bell, User, Terminal, LogOut, Waves, Users, Flame, Headphones, Cpu, Sparkles, Gamepad2, ShoppingCart } from "lucide-react";
...
export default function LeftSidebar() {
  ...
  const navItems = [
    ...
    { href: "/shop",             icon: ShoppingCart,  label: "[ SHOP ]",       hasNotifDot: false },
